				...
				<div id="list">
					...
					<ul id="viewArea">
						...
						<!-- 이미지반복영역 -->
							...
							<c:forEach items="${iList}" var="galleryVo">
								<li>
									<div class="view">
										<img class="imgItem" src="${pageContext.request.contextPath}/upload/${galleryVo.saveName}" data-imageNo="galleryVo.no">
				...
				<form method="post" action="${pageContext.request.contextPath}/gallery/upload" enctype="multipart/form-data" >
					<div class="modal-body">
						<div class="form-group">
							...
							<input id="addModalContent" type="text" name="comments">
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	$("#btnImgUpload").on("click", function() {
		console.log("이미지올리기버튼 클릭");
		$("#addModal").modal();
	});
	

	$(".imgItem").on("click", function() {
		console.log("이미지보기 팝업 모달창");
		$("#viewModal").modal();
	});
