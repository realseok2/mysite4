				...
				<div id="read">
					<form action="#" method="get">
						...
						<c:if test="${authUser.no == boardVo.userNo }">
							<a id="btn_modify" href="${pageContext.request.contextPath }/board/delete/${boardVo.no}">Delete </a>
						</c:if>	
						
						<c:if test="${authUser.no == boardVo.userNo }">
							<a id="btn_modify" href="${pageContext.request.contextPath }/board/modifyForm/${boardVo.no }">Modification</a>
						</c:if>
						
						<a id="btn_modify" href="${pageContext.request.contextPath }/board/list">List</a>
